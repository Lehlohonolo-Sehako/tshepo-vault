...
import reducer, {
  ...
  reset,
  updateEntity,
} from './verification-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERIFICATIONEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERIFICATIONEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERIFICATIONEVENT actions', async () => {
      const arg = { id: 15123 };
    ...
    it('dispatches UPDATE_VERIFICATIONEVENT actions', async () => {
      const arg = { id: 15123 };
    ...
    it('dispatches PARTIAL_UPDATE_VERIFICATIONEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERIFICATIONEVENT actions', async () => {
      const arg = 42666;
