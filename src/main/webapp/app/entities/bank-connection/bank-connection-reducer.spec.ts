...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKCONNECTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKCONNECTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKCONNECTION actions', async () => {
      const arg = { id: 12272 };
    ...
    it('dispatches UPDATE_BANKCONNECTION actions', async () => {
      const arg = { id: 12272 };
    ...
    it('dispatches PARTIAL_UPDATE_BANKCONNECTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANKCONNECTION actions', async () => {
      const arg = 42666;
