...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISSUEDCLAIM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ISSUEDCLAIM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ISSUEDCLAIM actions', async () => {
      const arg = { id: 22169 };
    ...
    it('dispatches UPDATE_ISSUEDCLAIM actions', async () => {
      const arg = { id: 22169 };
    ...
    it('dispatches PARTIAL_UPDATE_ISSUEDCLAIM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ISSUEDCLAIM actions', async () => {
      const arg = 42666;
