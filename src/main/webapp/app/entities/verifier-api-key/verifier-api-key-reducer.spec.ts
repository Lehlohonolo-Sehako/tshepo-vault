...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERIFIERAPIKEY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERIFIERAPIKEY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERIFIERAPIKEY actions', async () => {
      const arg = { id: 24127 };
    ...
    it('dispatches UPDATE_VERIFIERAPIKEY actions', async () => {
      const arg = { id: 24127 };
    ...
    it('dispatches PARTIAL_UPDATE_VERIFIERAPIKEY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERIFIERAPIKEY actions', async () => {
      const arg = 42666;
